...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'إنشاء لغة', href: '/web-settings/languages' },
];
...
// إرسال النموذج
const submit = () => {
    form.post('/web-settings/languages', {
        onSuccess: () => {
            form.reset();
        }
    });
                ...
                <form @submit.prevent="submit" class="flex flex-col gap-6">
                    <div class="grid gap-6">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="name" type="text" v-model="form.name" placeholder="أدخل اسم اللغة بالعربي" />
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="name_en" type="text" v-model="form.name_en" placeholder="Enter language name in English" />
